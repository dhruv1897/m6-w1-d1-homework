...
import { Button, Container, Form, FormGroup, Input, Label } from 'reactstrap'; // Corrected import from 'reactstrap' instead of 'bootstrap'
...
class InventoryEdit extends Component {
    ...
    async handleSubmit(event) {
        ...
        await fetch('/api/inventory', {
            method: item._id ? 'PUT' : 'POST', // Use 'PUT' for update and 'POST' for new entry
            headers: {
        ...
        this.props.history.push('/inventories'); // Navigate back to inventory list
    }
                ...
                <Container>
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup>
                            ...
                            <Input
                                type="number" // Changed to number input type for quantity
                                name="qty"
                                id="qty"
                                value={item.qty || ''}
                                onChange={this.handleChange}
